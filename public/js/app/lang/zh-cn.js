    ...
    return {
        ...
        topmenu: {
            ...
            device: {
                ...
                update_toolhead: '工具头软件',
                calibrate: '校正平台',
                set_to_origin: '回归原点',
                scan_laser_calibrate: '打开扫描激光',
                clean_calibration: '校正平台（清除原始数据）',
                commands: '指令',
                set_to_origin_complete: 'Delta 已回归原点',
                scan_laser_complete: '扫描激光已开启，电机 "完成" 以关闭激光',
                finish: '完成'
            },
            window: {
                label: '窗口',
        ...
        print: {
            ...
            advanced: {
                ...
                filament: '线料',
                temperature: '温度',
                detect_filament_runout: '检测线料',
                flux_calibration: '自动校正',
                detect_head_tilt: '检测工具头倾斜',
                layer_height_title: '层高',
                layer_height: '一般层高',
                firstLayerHeight: '地层层高',
                shell: '物件外壳',
                shellSurface: '物件外壳圈数',
                solidLayerTop: '顶部实心层数',
                solidLayerBottom: '地步实心层数',
                density: '填充密度',
                pattern: '填充图样',
